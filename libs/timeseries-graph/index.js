"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const F=require("react/jsx-runtime"),t=require("react"),O=require("@fi-sci/context-time-selection"),k=require("@fi-sci/time-scroll-view"),$=`"use strict";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
// export { }
`,q=({data:a,width:n,height:s})=>{const{visibleStartTimeSec:p,visibleEndTimeSec:f,reportTotalTimeRange:v,setVisibleTimeRange:y}=O.useTimeSelection(),{datasets:g,series:b,legendOpts:S,timeOffset:h,yRange:c,gridlineOpts:H,hideToolbar:T}=a,o=t.useMemo(()=>b.map(e=>{const i=g.filter(L=>L.name===e.dataset)[0];if(i===void 0)throw Error(`Dataset not found in series: ${e.dataset}`);return{...e,t:i.data[e.encoding.t],y:i.data[e.encoding.y]}}),[b,g]),{minTime:w,maxTime:R}=t.useMemo(()=>({minTime:m(o.map(e=>m(e.t))),maxTime:u(o.map(e=>u(e.t)))}),[o]),{minValue:l,maxValue:d}=t.useMemo(()=>c?{minValue:c[0],maxValue:c[1]}:{minValue:m(o.map(e=>m(e.y))),maxValue:u(o.map(e=>u(e.y)))},[c,o]);t.useEffect(()=>{const e=w+(h||0),i=R+(h||0);v(e,i),y(e,i)},[w,R,h,v,y]);const{canvasWidth:E,canvasHeight:D,margins:C}=k.useTimeScrollView({width:n,height:s,hideToolbar:T}),[W,V]=t.useState(!1),[x,P]=t.useState(),[r,I]=t.useState(null);t.useEffect(()=>{if(!x)return;const e=new Worker(URL.createObjectURL(new Blob([$],{type:"text/javascript"})),{type:"module"}),i=x.transferControlToOffscreen();return e.postMessage({canvas:i},[i]),I(e),()=>{e.terminate()}},[x]),t.useEffect(()=>{r&&r.postMessage({resolvedSeries:o})},[o,r]),t.useEffect(()=>{if(!r||p===void 0||f===void 0)return;const e={canvasWidth:E,canvasHeight:D,margins:C,visibleStartTimeSec:p,visibleEndTimeSec:f,hideLegend:W,legendOpts:S||{location:"northeast"},minValue:l,maxValue:d};r.postMessage({opts:e})},[E,D,C,p,f,r,W,S,l,d]);const A=t.useCallback(e=>{e.key==="l"&&V(i=>!i)},[]),M=t.useMemo(()=>({showTicks:!0,yMin:l,yMax:d}),[l,d]);return F.jsx(k.TimeScrollView,{onCanvasElement:e=>P(e),gridlineOpts:H,onKeyDown:A,width:n,height:s,yAxisInfo:M,hideToolbar:T})},m=a=>a.reduce((n,s)=>n<s?n:s,a[0]||0),u=a=>a.reduce((n,s)=>n>s?n:s,a[0]||0);exports.TimeseriesGraphView=q;
